...
namespace Entitas.CodeGeneration.Plugins {
    ...
    public class SAComponentContextGenerator : ICodeGenerator, IConfigurable {

        public string name { get { return "SA Component (Context API)"; } }
        ...
        const string SA_COMPONENT_TEMPLATE =
@"public partial class ${ContextName}Context {
    ...
    public ${ContextName}Entity Add${ComponentName}(System.Action<${ComponentType}> process = null) {
        ...
        entity.Add${ComponentName}(process);
        return entity;
    }
