...
namespace Entitas.CodeGeneration.Plugins {
    ...
    public class SAComponentEntityInterfaceGenerator : ICodeGenerator, IConfigurable {

        public string name { get { return "SA Component (Entity Interface)"; } }
        ...
        const string SA_INTERFACE_TEMPLATE =
@"public interface ${InterfaceName} {

    ${ComponentType} ${componentName} { get; }
    bool has${ComponentName} { get; }

    void Add${ComponentName}(System.Action<${ComponentType}> process);
    void Replace${ComponentName}();
