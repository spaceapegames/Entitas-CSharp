...
namespace Entitas.CodeGeneration.Plugins {
    ...
    public class SAComponentEntityGenerator : ICodeGenerator, IConfigurable {

        public string name { get { return "SA Component (Entity API)"; } }
...
@"public partial class ${ContextName}Entity {
    ...
    public void Add${ComponentName}(System.Action<${ComponentType}> process = null) 
    {
        var index = ${Index};
        var component = CreateComponent<${ComponentType}>(index);
        if (process != null)
            process.Invoke(component);
